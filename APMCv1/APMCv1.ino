/*
The Arduino Pulsed Motor Controller v1.0 by Jean-Louis Naudin
...
static int pulse_on          = 500;  // Pulse lagging after the TDC in µS
static int pulse_dur         = 2000; // Pulse duration in µS
...
#define AUTOSTART           ENABLED  // Autostart mode to help the starting

#define NUMB_POLES           6  // number of magnetic poles
...
{ 
   ...
   Serial.begin (115200);
   delay(2000);
   Serial.println("\n\nThe Arduino Pulsed Motor Controller APMC v1.0 by Jean-Louis Naudin\n\n");
#endif
